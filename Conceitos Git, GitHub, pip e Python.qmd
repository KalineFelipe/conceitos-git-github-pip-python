...
O pipi geralmente já vem instalado junto com o Python, mas em algumas instalações pode ser necessário ativá-lo ou instalá-lo separadamente. Ele gerencia bibliotecas que irá instalar, desinstalar e atualizar dentro do computador.
...
Parâmetros são variáveis que colocamos entre parênteses na definição de uma função. Que quando fazemos o chammamento da função, passamos valores reais para esses parâmetros, assim, esses valores são chamados de argumentos.
